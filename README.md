...
Tutte le librerie e funzioni utilizzate sono descritte nel file 'requirements.txt'. In particolare, sono
...
💡 La classificazione pura è stata implementata per diverse rappresentazioni del testo (BOW con pesi
   ...
   e massimo numero di gram, nello specifico:
	- Script/Classificazione(1,1).ipybn: il vocabolario è costituito solo da 1-gram.
	- Script/Classificazione(1,2).ipybn: il vocabolario è costituito da 1-gram e 2-gram
	- Script/Classificazione(2,2).ipybn: solo 2-gram costituiscono il vocabolario.
...
💡 Per la sentiment supervised analysis vi è un solo file jupyter: Script/Classification_sentiment.ipybn
